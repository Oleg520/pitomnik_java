...
```
 ...
 oleg520@oleg-linux:\~$ cd Pitomnik2/

oleg520@oleg-linux:\~/Pitomnik2$ cat \> Pets.txt
...
oleg520@oleg-linux:\~/Pitomnik2$ cat \> PackAnimals.txt
...
oleg520@oleg-linux:\~/Pitomnik2$ cat Pets.txt PackAnimals.txt \> Animals.txt

oleg520@oleg-linux:\~/Pitomnik2$ cat Animals.txt
...
oleg520@oleg-linux:\~/Pitomnik2$ mv Animals.txt HumanFriends.txt

oleg520@oleg-linux:\~/Pitomnik2$ ls

HumanFriends.txt  PackAnimals.txt  Pets.txt  
oleg520@oleg-linux:\~/Pitomnik2$ mkdir PetsDirectory

oleg520@oleg-linux:\~/Pitomnik2$ mv HumanFriends.txt PetsDirectory/

oleg520@oleg-linux:\~/Pitomnik2$ cd PetsDirectory/

oleg520@oleg-linux:\~/Pitomnik2/PetsDirectory$ ls

HumanFriends.txt
```
## 3\. oleg520@oleg-linux:\~/Pitomnik2/PetsDirectory$ sudo apt-get update
```
\[sudo\] пароль для oleg520:
...
oleg520@oleg-linux:\~/Pitomnik2/PetsDirectory$ sudo apt-get intstall mysql-server

E: Неверная операция intstall

oleg520@oleg-linux:\~/Pitomnik2/PetsDirectory$ sudo apt-get install mysql-server
...
oleg520@oleg-linux:\~/Pitomnik2/PetsDirectory$ mysql \--version

mysql  Ver 8.0.39 for Linux on x86\_64 (MySQL Community Server \- GPL)
```
## 4\.
```
oleg520@oleg-linux:\~/Pitomnik2/PetsDirectory$ sudo apt-get install cowsay
...
oleg520@oleg-linux:\~/Pitomnik2/PetsDirectory$ cowsay "Приветствую\!"
...
oleg520@oleg-linux:\~/Pitomnik2/PetsDirectory$ sudo apt-get remove cowsay
...
## 5\.  
``` 
oleg520@oleg-linux:\~/Pitomnik2/PetsDirectory$ history \> history.txt
